...
interface MarketingNavProps {
  onNavigate: (section: 'tips' | 'platforms' | 'contentTypes' | 'videoLessons' | 'resources' | 'faq' | 'getApp' | 'pricing' | 'payments') => void;
...
export default function MarketingNav({ onNavigate, searchIndex, onSearchResultClick }: MarketingNavProps) {
  ...
  const navItems = [
    ...
    { label: 'Video Lessons', section: 'videoLessons' as const },
  ...
  const handleNavClick = (section: 'tips' | 'platforms' | 'contentTypes' | 'videoLessons' | 'resources' | 'faq' | 'getApp' | 'pricing' | 'payments') => {
    onNavigate(section);
    setIsOpen(false);
  };
